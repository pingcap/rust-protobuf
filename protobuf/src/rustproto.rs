...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tobuf.MessageOptionsR\x11generateAccessors:^\n\x1acarllerche_bytes_for_b\
    ytes\x18\xf3\x84\x01\x20\x01(\x08\x12\x1f.google.protobuf.MessageOptions\
    R\x17carllercheBytesForBytes:`\n\x1bcarllerche_bytes_for_string\x18\xf4\
    ...
    obuf.FieldOptionsR\x16generateAccessorsField:g\n\x20carllerche_bytes_for\
    _bytes_field\x18\xf3\x84\x01\x20\x01(\x08\x12\x1d.google.protobuf.FieldO\
    ptionsR\x1ccarllercheBytesForBytesField:i\n!carllerche_bytes_for_string_\
    field\x18\xf4\x84\x01\x20\x01(\x08\x12\x1d.google.protobuf.FieldOptionsR\
    \x1dcarllercheBytesForStringFieldJ\x80\x10\n\x06\x12\x04\0\0.\x01\n\x08\
    ...
    \x05\x12\x03\x15\x04+\x1aC\x20When\x20true,\x20will\x20only\x20generate\
    \x20codes\x20that\x20works\x20with\x20lite\x20runtime.\n\n\n\n\x03\x07\
    \x05\x02\x12\x03\t\x07\"\n\n\n\x03\x07\x05\x04\x12\x03\x15\x04\x0c\n\n\n\
    \x03\x07\x05\x05\x12\x03\x15\r\x11\n\n\n\x03\x07\x05\x01\x12\x03\x15\x12\
    \"\n\n\n\x03\x07\x05\x03\x12\x03\x15%*\n\t\n\x01\x07\x12\x04\x18\0#\x01\
    \n7\n\x02\x07\x06\x12\x03\x1a\x04'\x1a,\x20When\x20true,\x20oneof\x20fie\
    ld\x20is\x20generated\x20public\n\n\n\n\x03\x07\x06\x02\x12\x03\x18\x07%\
    \n\n\n\x03\x07\x06\x04\x12\x03\x1a\x04\x0c\n\n\n\x03\x07\x06\x05\x12\x03\
    \x1a\r\x11\n\n\n\x03\x07\x06\x01\x12\x03\x1a\x12\x1e\n\n\n\x03\x07\x06\
    \x03\x12\x03\x1a!&\nI\n\x02\x07\x07\x12\x03\x1c\x04(\x1a>\x20When\x20tru\
    e\x20all\x20fields\x20are\x20public,\x20and\x20not\x20accessors\x20gener\
    ated\n\n\n\n\x03\x07\x07\x02\x12\x03\x18\x07%\n\n\n\x03\x07\x07\x04\x12\
    \x03\x1c\x04\x0c\n\n\n\x03\x07\x07\x05\x12\x03\x1c\r\x11\n\n\n\x03\x07\
    \x07\x01\x12\x03\x1c\x12\x1f\n\n\n\x03\x07\x07\x03\x12\x03\x1c\"'\nP\n\
    \x02\x07\x08\x12\x03\x1e\x04-\x1aE\x20When\x20false,\x20`get_`,\x20`set_\
    `,\x20`mut_`\x20etc.\x20accessors\x20are\x20not\x20generated\n\n\n\n\x03\
    \x07\x08\x02\x12\x03\x18\x07%\n\n\n\x03\x07\x08\x04\x12\x03\x1e\x04\x0c\
    ...
    \x03\x07\t\x02\x12\x03\x18\x07%\n\n\n\x03\x07\t\x04\x12\x03\x20\x04\x0c\
    \n\n\n\x03\x07\t\x05\x12\x03\x20\r\x11\n\n\n\x03\x07\t\x01\x12\x03\x20\
    \x12,\n\n\n\x03\x07\t\x03\x12\x03\x20/4\n3\n\x02\x07\n\x12\x03\"\x046\
    \x1a(\x20Use\x20`bytes::Bytes`\x20for\x20`string`\x20fields\n\n\n\n\x03\
    \x07\n\x02\x12\x03\x18\x07%\n\n\n\x03\x07\n\x04\x12\x03\"\x04\x0c\n\n\n\
    \x03\x07\n\x05\x12\x03\"\r\x11\n\n\n\x03\x07\n\x01\x12\x03\"\x12-\n\n\n\
    \x03\x07\n\x03\x12\x03\"05\n\t\n\x01\x07\x12\x04%\0.\x01\nI\n\x02\x07\
    \x0b\x12\x03'\x04.\x1a>\x20When\x20true\x20all\x20fields\x20are\x20publi\
    c,\x20and\x20not\x20accessors\x20generated\n\n\n\n\x03\x07\x0b\x02\x12\
    ...
    \x03\x07\r\x05\x12\x03+\r\x11\n\n\n\x03\x07\r\x01\x12\x03+\x122\n\n\n\
    \x03\x07\r\x03\x12\x03+5:\n3\n\x02\x07\x0e\x12\x03-\x04<\x1a(\x20Use\x20\
    `bytes::Bytes`\x20for\x20`string`\x20fields\n\n\n\n\x03\x07\x0e\x02\x12\
    \x03%\x07#\n\n\n\x03\x07\x0e\x04\x12\x03-\x04\x0c\n\n\n\x03\x07\x0e\x05\
    \x12\x03-\r\x11\n\n\n\x03\x07\x0e\x01\x12\x03-\x123\n\n\n\x03\x07\x0e\
    \x03\x12\x03-6;\
";
